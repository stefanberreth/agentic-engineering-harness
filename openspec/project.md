...
- **BACKLOG.md** (local-only) is the maintainer's triage scratchpad; promoting an entry off BACKLOG into a real OpenSpec change is a deliberate decision made when the change is ready to design.
